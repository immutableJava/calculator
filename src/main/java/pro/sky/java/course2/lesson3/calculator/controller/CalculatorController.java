...
public class CalculatorController {
    ...
    public String showQuotientOfTwoNumbers(@RequestParam int num1, @RequestParam int num2) {
        if (calculatorService.getQuotientOfTwoNumbers(num1, num2).equals("Деление на 0 недопустимо.")) {
            return calculatorService.getQuotientOfTwoNumbers(num1, num2);
        }
        return String.format("%d / %d = %s", num1, num2, calculatorService.getQuotientOfTwoNumbers(num1, num2));
    }
}
